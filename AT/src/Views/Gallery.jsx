...
export default function Gallery() {
    const images = [
        { src: G1, title: "G1 Raw effluent Receiving Sump" },
        { src: G2, title: "G2 Chemical House" },
        { src: G3, title: "G3 Equalization Tank With OHR" },
        { src: G4, title: "G4 Pre Settler" },
        { src: G5, title: "G5 Filtrate Holding Tank" },
        { src: G6, title: "G6 Fliter Press" },
        { src: G7, title: "G7 Fliter Press Washing pump" },
        { src: G8, title: "G8 Primary Clarifier" },
        { src: G9, title: "G9 Dual Media Filter" },
        { src: G10, title: "G10 Aeration tank" },
        { src: G11, title: "G11 Secondary Clarifier" },
        { src: G12, title: "G12 Tertiary Clarifier" },
        { src: G13, title: "G13 Pelletizer & Circulation Pumps" },
        { src: G14, title: "G14 Auto Disc Filter" },
        { src: G15, title: "G15 Ultra Filtration System" },
    ];
  return (
    <>
